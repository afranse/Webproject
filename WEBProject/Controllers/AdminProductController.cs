...
namespace WEBProject.Controllers
{
    public class AdminProductController : Controller
    {
        ...
        public AdminProductController(WebsiteContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArticleNumber,Name,Description,Contents")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProductExists(product.ArticleNumber))
                    {
                        return NotFound();
                    }
                    else
